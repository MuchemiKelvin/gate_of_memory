...
class _ImagesPageState extends State<ImagesPage> {
  ...
  Future<void> _loadMemorialData() async {
    ...
    try {
      ...
      print('  - Image Path: "${foundMemorial.imagePath}"');
      print('  - Image Path isEmpty: ${foundMemorial.imagePath.isEmpty}');
      
      final imagePaths = [foundMemorial.imagePath].where((path) => path != null && path.isNotEmpty).toList();
      print('✓ Filtered image paths: $imagePaths (count: ${imagePaths.length})');
